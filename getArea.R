getArea <- function(f) {
  # Adjust the path below to match the location of the leafarea folder on your desktop
  # For macOS/Linux:
  filepath <- paste0("/Users/srashtibajpai/Desktop/leafarea/", f)

  # filepath <- paste0("C:/Users/srashtibajpai/Desktop/leafarea/", f)
  
  i <- normalize(readImage(filepath))
